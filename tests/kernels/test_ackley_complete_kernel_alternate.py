...
from gumps.kernels.ackley_complete_kernel import AckleyCompleteKernelAlternate, AckleyCompleteState
from gumps.studies import SimpleSimulationStudy


class TestAckleyCompleteKernelAlternate(unittest.TestCase):
...
if __name__ == "__main__":
    suite = unittest.TestLoader().loadTestsFromTestCase(TestAckleyCompleteKernelAlternate)
